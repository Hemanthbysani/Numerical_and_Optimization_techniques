import numpy as np
#please import and install the numpy tool using "pip install numpy"
#Defining the function 
def f(x,y,z):
    return (3/2)*(x**2)+2*(y**2)+(3/2)*(z**2)+x*z+2*y*z-3*x-z

#First Derivative of function using arrays
def fprime(x,y,z):
    return np.array((3*x+z-3,4*y+2*z,x+2*y+3*z-1));
    
#Second Derivative of function using arrays
def fsecond(x,y,z):
